...
public class PCATestCPDummyCase {

  public PCATestCPDummyCase() {
  }

  public static void main(String[] argv) {
    PCATestCPDummyCase pCATestDummyCase = new PCATestCPDummyCase();
...
//*/
    ...
    try {
      pca.setGuideline(  "Chronic Pain Opioid Guideline" );
    } catch (Throwable e) {
      System.out.println("Problem creating PCA session");
      e.printStackTrace();
      System.exit(-1);
