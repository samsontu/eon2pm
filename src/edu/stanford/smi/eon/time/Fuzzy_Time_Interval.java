...
/** 
 */
public class Fuzzy_Time_Interval extends Absolute_Time_Interval {

	public Fuzzy_Time_Interval(KnowledgeBase kb, FrameID id ) {
		super(kb, id);
	}
	...
	public void setfuzzy_time_pointValue(Instance fuzzy_time_point) {
		ModelUtilities.setOwnSlotValue(this, "fuzzy_time_point", fuzzy_time_point);	}
	public Instance getfuzzy_time_pointValue() {
		return ((Instance) ModelUtilities.getOwnSlotValue(this, "fuzzy_time_point"));
	}
