...
/** 
 *  a period of time, with a ceratin granularity. e.g. 3 weeks with accuracy of a day
 */
public abstract class Time_Interval extends Time_Entity {

	public Time_Interval(KnowledgeBase kb, FrameID id ) {
		super(kb, id);
	}
