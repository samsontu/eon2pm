...
<p>
<ul>
<li> <b>Java Class</b> edu.stanford.smi.eon.PCAServerModule.Current_Activity_Evaluation
<li> <b>Source File</b> edu/stanford/smi/eon/PCAServerModule/Current_Activity_Evaluation.java
<li> <b>IDL Source File</b> PCAServer.idl
<li> <b>IDL Absolute Name</b> ::PCAServerModule::Current_Activity_Evaluation
<li> <b>Repository Identifier</b> IDL:PCAServerModule/Current_Activity_Evaluation:1.0
</ul>
<b>IDL definition:</b>
<pre>
    #pragma prefix "PCAServerModule"
    struct Current_Activity_Evaluation {
      string description;
      string name;
      ::PCAServerModule::Guideline_Entity guideline_id;
      string activity_to_evaluate;
...
*/
final public class Current_Activity_Evaluation implements java.io.Serializable {
  public java.lang.String description;
  public java.lang.String name;
  public edu.stanford.smi.eon.PCAServerModule.Guideline_Entity guideline_id;
  public java.lang.String activity_to_evaluate;
  ...
  public Current_Activity_Evaluation(
    ...
    this.activity_to_evaluate = activity_to_evaluate;
