...
<p>
<ul>
<li> <b>Java Class</b> edu.stanford.smi.eon.PCAServerModule.Guideline_Activity_Choices
<li> <b>Source File</b> edu/stanford/smi/eon/PCAServerModule/Guideline_Activity_Choices.java
<li> <b>IDL Source File</b> PCAServer.idl
<li> <b>IDL Absolute Name</b> ::PCAServerModule::Guideline_Activity_Choices
<li> <b>Repository Identifier</b> IDL:PCAServerModule/Guideline_Activity_Choices:1.0
</ul>
<b>IDL definition:</b>
<pre>
    #pragma prefix "PCAServerModule"
    struct Guideline_Activity_Choices {
      string guideline_id;
      ::PCAServerModule::Activity_ChoiceSeq choices;
...
*/
final public class Guideline_Activity_Choices implements java.io.Serializable {
  public java.lang.String guideline_id;
  public edu.stanford.smi.eon.PCAServerModule.Activity_Choice[] choices;
  ...
  public Guideline_Activity_Choices() {
  }
  public Guideline_Activity_Choices(
    java.lang.String guideline_id,
    edu.stanford.smi.eon.PCAServerModule.Activity_Choice[] choices,
