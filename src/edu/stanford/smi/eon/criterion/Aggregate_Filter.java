...
/** 
 */
public class Aggregate_Filter extends Filter {

	public Aggregate_Filter(KnowledgeBase kb, FrameID id ) {
		super(kb, id);
	}

	public void setchildrenValue(Collection children) {
		ModelUtilities.setOwnSlotValues(this, "children", children);	}
	public Collection getchildrenValue(){
		return  ModelUtilities.getOwnSlotValues(this, "children");
	}
