				...
				if ((currentActivityLevel == null) || (changeToNextLevel(interpreter, currentActivityLevel, evaluateObject))) {
					...
					if (noUncontrollableModifyCondition(stopUncontrollableIntensifyConditionCollection, 
						...
						changeEval = new Change_Attribute_Evaluation("",
								...
								(activityEval != null) ? (Matched_Data[]) activityEval.is_first_line_drug_for.toArray(new Matched_Data[0]) : null,
								(activityEval != null) ? (Matched_Data[]) activityEval.is_second_line_drug_for.toArray(new Matched_Data[0]) : null,
								(activityEval != null) ? (Matched_Data[]) activityEval.is_third_line_drug_for.toArray(new Matched_Data[0]) : null,
