...
/** 
 */
public class General_Conditional_Goal extends Goal_Entity {

	public General_Conditional_Goal(KnowledgeBase kb, FrameID id ) {
		super(kb, id);
	}

	public void setcriteria_to_achieveValue(Collection criteria_to_achieve) {
		ModelUtilities.setOwnSlotValues(this, "criterion_to_achieve", criteria_to_achieve);	}
	public Collection getcriteria_to_achieveValue() {
		return ((Collection) ModelUtilities.getOwnSlotValues(this, "criterion_to_achieve"));
	}
	...
	public void setselection_criteriaValue(Collection selection_criteria) {
		ModelUtilities.setOwnSlotValues(this, "selection_criterion", selection_criteria);	}
	public Collection getselection_criteriaValue() {
		return ((Collection) ModelUtilities.getOwnSlotValues(this, "selection_criterion"));
	}
