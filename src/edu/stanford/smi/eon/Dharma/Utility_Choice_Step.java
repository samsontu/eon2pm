 ...
 */
public class Utility_Choice_Step extends Decision {

	public Utility_Choice_Step(KnowledgeBase kb, FrameID id ) {
		super(kb, id);
	}

	public void setdecision_modelValue(Instance decision_model) {
		ModelUtilities.setOwnSlotValue(this, "decision_model", decision_model);	}
	public Instance getdecision_modelValue() {
		return ((Instance) ModelUtilities.getOwnSlotValue(this, "decision_model"));
	}
