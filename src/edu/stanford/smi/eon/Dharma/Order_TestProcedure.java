...
/** 
 */
public class Order_TestProcedure extends Action_Specification {

	public Order_TestProcedure(KnowledgeBase kb, FrameID id ) {
		super(kb, id);
	}
	...
	public void settest_or_procureValue(Instance test_or_procure) {
		ModelUtilities.setOwnSlotValue(this, "test_or_procure", test_or_procure);	}
	public Instance gettest_or_procureValue() {
		return ((Instance) ModelUtilities.getOwnSlotValue(this, "test_or_procure"));
	}
// __Code above is automatically generated. Do not change
	...
	public Action_Spec_Record  evaluateActionSpec(GuidelineInterpreter gmanager) {
		...
		Action_Spec_Record actionSpec = new edu.stanford.smi.eon.PCAServerModule.Order_TestProcedure(
				getlabelValue(),
				getdescriptionValue(), "Order_TestProcedure",
				...
				getcodeValue(),
				getcoding_systemValue(),
				gettest_or_procedureValue(),
...
private String getWhen(Instance getwhenValue) {
	if (getwhenValue != null)
		return getwhenValue.getBrowserText();
	else return null;
	}

private String gettest_or_procedureValue() {
	if (ModelUtilities.getOwnSlotValue(this, "test_or_procedure") != null) {
		return ((Cls)ModelUtilities.getOwnSlotValue(this, "test_or_procedure")).getBrowserText();
	} else 
		return null;
}
