...
%JRE%\bin\java %OPTIONS%  -Dprotege.dir="%LIB%" -cp %CLASSPATH%  edu.stanford.smi.eon.clients.TestEONExecEngineAPIForInpatient %EONHOME%\ini\BMIRInpatientEON.ini  2011-10-29 2012-10-30
